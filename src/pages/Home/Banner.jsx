        ...
        <div className=' bg-white  px-4 lg:px-24 flex items-center'>
            <div className='flex flex-col md:flex-row-reverse justify-between items-center gap-12 py-40'>
                ...
                <div className='md:w-1/2 space-y-8'>
                    <h1 className='lg:text-6xl text-5xl font-bold text-black mb-5 lg:leading-tight leading-snug'>Монгол модон барын бүтээлүүдийг <span className='text-blue-700'> ангилан , бүртгэх систем</span></h1>
